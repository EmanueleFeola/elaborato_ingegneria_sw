...
public class ManagerDashboardController {
    ...
    private void initialize() {
        ...
        managerTable.getSelectionModel().selectedItemProperty().addListener(
    ...
    /**
     * Fills all text fields to show details about the manager.
     * If the specified manager is null, all text fields are cleared.
     * 
    ...
    private void handleNewManager() {
        ...
        boolean okClicked = showManagerEditDialog(m);
    ...
    public boolean showPersonEditDialog(Manager m) {
    	return false;
    }
    
    private boolean showManagerEditDialog(Manager tempPerson) {
		return false;
	}
